	...
	render() {
		...
		return (
			<div className="loginForm">
				<Panel className="panelbodymargin">
					<Panel.Heading className="loginpagehead">User Login</Panel.Heading>
					<Panel.Body>
						<form onSubmit={this.login}>
							...
							<Button type="submit" className="button-colors signbtn" bsStyle="primary">Sign-In</Button>
						</form>
					</Panel.Body>
				</Panel>
			</div>
